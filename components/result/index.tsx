...
const IconSuccess: FC = () => {
  return (
    <svg className='h-14 w-14' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        className='fill-success stroke-success-dark'
  ...
  return (
    <svg className='h-14 w-14' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        className='fill-warning stroke-warning-dark'
        strokeWidth='4'
        strokeLinejoin='round'
      />
  ...
  return (
    <svg className='h-14 w-14' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        className='fill-danger stroke-danger-dark'
        strokeWidth='4'
        strokeLinejoin='round'
      />
      <path
...
const Result = ({ title, desc, footer, type = 'info', state = 404 }: ResultProps) => {
  return (
